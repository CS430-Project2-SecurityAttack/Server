...
def create_bank_account(db: Session, bank_account: schemas.BankAccountCreate):
    ...
    Args:
        ...
        bank_account (schemas.BankAccountCreate): The bank account data.

    Returns:
        models.BankAccount: The created bank account.
    """
    db_bank_account = models.BankAccount(routing_number=bank_account.routing_number, account_holder=bank_account.account_holder, account_number=bank_account.account_number)
